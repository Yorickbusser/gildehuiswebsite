  ...
  <div class="dividertekstlijst">
    ...
    echo "
      <table>
        <tr>
          <th>Kok</th>
          <th style='border-right:solid 100px transparent;'>Datum</th>
          <th>Gerecht</th>
          <th style='border-right:solid 100px transparent;'>Kosten</th>
          <th>Meeëters</th>
        </tr>\n\n";
    ...
    //is de ah nog open?
    //is de uni nog open?
    //is de wasmachine vrij? ja geen idee man, wasmachine dipsen
    ?>
